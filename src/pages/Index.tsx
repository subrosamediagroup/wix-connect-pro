  ...
  <>
    ...
    <section className="relative h-[90vh] min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <motion.div initial="hidden" animate="visible" className="relative z-10 text-center px-4 max-w-3xl mx-auto">
        <motion.p variants={fadeUp} custom={0} className="text-primary font-semibold uppercase tracking-[0.3em] text-sm mb-4">
          Since 1962 · Lawrence, MA → Florida
        </motion.p>
        ...
        <motion.p variants={fadeUp} custom={2} className="mt-4 text-primary-foreground/80 text-lg sm:text-xl max-w-xl mx-auto">
          Classic, mouthwatering pizzas and fresh, hearty subs — now proudly serving Florida.
        </motion.p>
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="grid gap-8 md:grid-cols-2 items-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }}>
            <motion.img variants={fadeUp} src={subSandwich} alt="Fresh submarine sandwich" className="rounded-lg shadow-xl w-full h-80 object-cover" />
          </motion.div>
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }}>
